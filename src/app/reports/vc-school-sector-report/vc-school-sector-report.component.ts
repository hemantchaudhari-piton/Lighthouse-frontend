...
export class VCSchoolSectorReportComponent extends BaseListComponent<VCSchoolSectorReportModel> implements OnInit {
  ...
  exportExcel(): void {
    ...
    this.reportService.GetVCSchoolSectorReportsByCriteria(reportParams).subscribe(response => {
      ...
      const columns = ['SrNo', 'AcademicYear', 'SchoolAllottedYear', 'SectorName', 'PhaseName', 'SchoolName', 'VTPName', 'VCName', 'VCMobile', 'VCEmail', 'DateOfAllocation', 'DateOfRemoval'];
      ...
      this.exportExcelFromTable(filledData, "VCSchoolSectors");
      this.IsLoading = false;
