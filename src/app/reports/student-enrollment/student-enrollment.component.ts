...
export class StudentEnrollmentComponent extends BaseListComponent<StudentEnrollmentModel> implements OnInit {
  ...
  getStudentEnrollmentReports(): void {
    ...
    this.studentEnrollmentForm.get('AcademicYearId').disable();
    ...
    this.reportService.GetStudentEnrollmentReportsByCriteria(reportParams).subscribe(response => {
      this.displayedColumns = ['SrNo', 'AcademicYear', 'SchoolAllottedYear', 'PhaseName', 'VTPName', 'VCName', 'VCMobile', 'VCEmail', 'VTName', 'VTMobile', 'VTEmail', 'VTDateOfJoining', 'HMName', 'HMMobile', 'HMEmail', 'SchoolManagement', 'DivisionName', 'DistrictName', 'BlockName', 'UDISE', 'SchoolName', 'SectorName', 'JobRoleName', 'ClassName', 'NewEnrollment', 'TotalEnrollmentStudents', 'EnrolledBoys', 'EnrolledGirls', 'EnrolledOthers','Dropout','FailedStudents'];
  ...
  exportExcel(): void {
    ...
    this.reportService.GetStudentEnrollmentReportsByCriteria(reportParams).subscribe(response => {
      ...
      this.exportExcelFromTable(response.Results.$values, "StudentEnrollment");
      this.IsLoading = false;
